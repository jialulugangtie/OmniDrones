...
[![IsaacSim](https://img.shields.io/badge/Isaac%20Sim-5.0.0-orange.svg)](https://docs.isaacsim.omniverse.nvidia.com/5.0.0/index.html)
[![IsaacLab](https://img.shields.io/badge/Isaac%20Lab-2.2.2-blue.svg)](https://isaac-sim.github.io/IsaacLab/)
...
For usage and more details, please refer to the [documentation](https://omnidrones.readthedocs.io/en/latest/). This branch targets **Linux (Ubuntu 22.04/24.04)** with Isaac Sim 5.0 pip install. See [docs/source/installation.rst](docs/source/installation.rst) and [requirements-isaac5.txt](requirements-isaac5.txt).

Welcome to join our [Discord](https://discord.gg/J4QvXR6tQj) for discussions and questions!

## Notice

The initial release of **OmniDrones** is developed based on Isaac Sim 2022.2.0. It can be found at the [release](https://github.com/btx0424/OmniDrones/tree/release) branch. **This branch targets Isaac Sim 5.0 + Isaac Lab 2.2.2.** Older Isaac Sim 4.1.0 code is available in git history.
